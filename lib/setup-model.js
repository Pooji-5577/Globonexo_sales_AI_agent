...
export const SETUP_STEP_META = {
  ...
  icp: {
    ...
    why: "Apollo searches and lead scoring both filter on this.",
    cta: "Define your ICP",
    href: "/onboarding",
    icon: "target",
    group: "Tell the agent about you",
  ...
  gmail: {
    ...
    why: "Required for email campaigns. Nothing sends until this is connected.",
    cta: "Connect Gmail",
    href: "/settings",
    icon: "mail",
  ...
  calendar: {
    ...
    summary: "Real availability, and native events when a prospect says yes.",
    why: "Without it the agent can talk about a meeting but cannot book one.",
  ...
  leads: {
    ...
    summary: "Add people by CSV, manually, or from an Apollo search.",
  ...
  launch: {
    ...
    summary: "Check the messaging and limits, then go live.",
    why: "Nothing sends until you launch — review first.",
