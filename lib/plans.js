...
export const PLAN_CONFIG = [
  {
    ...
    voiceCampaigns: 1,
    dailyEmailCap: 100,
    desc: 'For solo reps getting started with the core sales loop.',
    feats: ['2,645 credits/month', '3 email campaigns', '1 voice campaign', 'AI email sequences', 'Apollo lead enrichment', 'AI voice calling'],
  },
  {
    id: 'growth',
    name: 'Growth',
    ...
    voiceCampaigns: 4,
    dailyEmailCap: 200,
    desc: 'For small sales teams running more of the same core loop.',
    feats: ['5,370 credits/month', '10 email campaigns', '4 voice campaigns', 'AI email sequences', 'Apollo lead enrichment', 'AI voice calling'],
  },
  {
    id: 'scale',
    name: 'Scale',
    ...
    voiceCampaigns: 10,
    dailyEmailCap: 500,
    desc: 'For teams that need higher volume and admin cost visibility.',
    feats: ['14,370 credits/month', '25 email campaigns', '10 voice campaigns', 'AI email sequences', 'Apollo lead enrichment', 'AI voice calling'],
  },
];
