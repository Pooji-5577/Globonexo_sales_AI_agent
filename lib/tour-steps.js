...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body:
      ...
      "background and enriching matching leads — title, company size, technologies, hiring signals. This card " +
      "tracks that progress. It keeps running even if you close this tour.",
  },
  {
    id: "review",
    route: "/campaigns",
    dynamicRoute: "onboardingCampaign",
    target: '[data-tour="campaign-leads"]',
    placement: "top",
    title: "Review your first campaign",
    body:
      "This is the campaign we built from your onboarding answers: audience, messaging, and the sequence, with " +
      "the leads Apollo just enriched already attached. Skim the list — nothing has been sent, and you can " +
      "still add or remove leads before it goes out.",
  },
  {
    id: "launch",
    route: "/campaigns",
    ...
    title: "Launch it",
    body:
      "When the audience and messaging look right, hit Launch. Sending respects the business hours and daily " +
      "cap already set on this campaign, and the sequence stops automatically on a reply, a bounce, an " +
      "unsubscribe, or a booked meeting.",
