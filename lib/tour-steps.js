...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    title: "Calendar",
    body:
      "Set your working hours, meeting length, and notice window here. When a prospect agrees to a meeting on a " +
      "call, the agent checks this availability live, offers open slots, and locks one in the moment they confirm " +
      "— no external calendar connection required.",
  },
  {
    id: "analytics",
    route: "/analytics",
