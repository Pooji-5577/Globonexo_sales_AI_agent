 ...
 *
 * Kept separate from the overlay component so the rules that matter, such as where a
 ...
 * server-derived status says "complete". This is the same status the checklist
